...
const trimAndCollapseWhitespace = (value) => value
    .replace(/\s+/g, " ")
    .trim();
const optionalTrimmed = (maxLength) => z
    .string()
    .max(maxLength)
    .trim()
...
export const captureRecordSchema = z
    ...
    .strict();
export const normalizeCaptureIngest = (input) => captureIngestSchema.parse(input);
export const toCaptureRecord = (input, nowIso = new Date().toISOString()) => {
